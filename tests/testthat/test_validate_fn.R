...
test_that("binomial glm model works with validate_fn()", {
  ...
  expect_equal(
    ...
    tolerance = 1e-4)
  expect_equal(
    Vbinomlist_list[["Positive Class"]],
    c("1", "1", "1", "1", "1", "1", "1", "1"),
    fixed = TRUE)
  expect_equal(
    Vbinomlist_list[["Family"]],
  ...
  expect_equal(
    ...
    c("Fixed", "Balanced Accuracy", "F1", "Sensitivity", "Specificity",
      ...
      "Warnings and Messages", "Positive Class", "Family", "HParams",
      "Model", "Dependent"),
    fixed = TRUE)
  # Testing column classes
  expect_equal(
    xpectr::smpl(xpectr::element_classes(Vbinomlist_list), n = 30),
    c("character", "numeric", "numeric", "numeric", "numeric", "numeric",
      "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
      "numeric", "numeric", "numeric", "numeric", "numeric", "list",
      "list", "list", "list", "list", "integer", "integer", "list",
      "character", "character", "list", "list", "character"),
    fixed = TRUE)
  # Testing column types
  expect_equal(
    xpectr::smpl(xpectr::element_types(Vbinomlist_list), n = 30),
    c("character", "double", "double", "double", "double", "double",
      "double", "double", "double", "double", "double", "double",
      "double", "double", "double", "double", "double", "list", "list",
      "list", "list", "list", "integer", "integer", "list", "character",
      "character", "list", "list", "character"),
    fixed = TRUE)
  # Testing dimensions
  expect_equal(
    dim(Vbinomlist_list),
...
test_that("fuzz testing validate_fn()", {
  ...
  expect_equal(
    output_19148[["Family"]],
    c("binomial", "binomial", "binomial", "binomial"),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    c("character", "numeric", "numeric", "list", "logical", "list",
      "list", "list", "integer", "integer", "list", "character", "character",
      "list", "list", "character"),
    fixed = TRUE)
  # Testing column types
  expect_equal(
    ...
    c("character", "double", "double", "list", "logical", "list", "list",
      "list", "integer", "integer", "list", "character", "character",
      "list", "list", "character"),
    fixed = TRUE)
  # Testing dimensions
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'family': Must be element of set {'gaussian','binomial','multinomial'}, but is 'NA'."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'family': Must be element of set {'gaussian','binomial','multinomial'}, but types do not match (numeric\n * != character)."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'family': Must be element of set {'gaussian','binomial','multinomial'}, but is 'lol'."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("unused arguments (formula = model_formula, train_data = train_set, hyperparameters = hparams)"),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("'model_fn' was not a function."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("'model_fn' was NULL."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("\n-------------------------------------\nvalidate_fn(): Error:\nIn formula:\ndiagnosis~score\nFor fold column:\n.partitions\nIn fold:\n2\nError in value[[3L]](cond): Got the following error while using specified 'predict_fn': Error in user_predict_fn(test_data = test_data, model = model, formula = stats::as.formula(formula), : unused arguments (test_data = test_data, model = model, formula = stats::as.formula(formula), hyperparameters = hyperparameters)\n\n"),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("'predict_fn' was not a function."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("'predict_fn' was NULL."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("\n-------------------------------------\nvalidate_fn(): Error:\nIn formula:\n~\nFor fold column:\n.partitions\nIn fold:\n2\nHyperparameters:\na : 1, b : 3\nError in preprocess_fn(train_data = train_data, test_data = test_data, : unused arguments (train_data = train_data, test_data = test_data, formula = current_formula, hyperparameters = current_hparams)\n\n-------------------------------------\nvalidate_fn(): Error:\nIn formula:\ndiagnosis\nFor fold column:\n.partitions\nIn fold:\n2\nHyperparameters:\na : 1, b : 3\nError in preprocess_fn(train_data = train_data, test_data = test_data, : unused arguments (train_data = train_data, test_data = test_data, formula = current_formula, hyperparameters = current_hparams)\n\n-------------------------------------\nvalidate_fn(): Error:\nIn formula:\nscore\nFor fold column:\n.partitions\nIn fold:\n2\nHyperparameters:\na : 1, b : 3\nError in preprocess_fn(train_data = train_data, test_data = test_data, : unused arguments (train_data = train_data, test_data = test_data, formula = current_formula, hyperparameters = current_hparams)\n"),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("'preprocess_fn' was not a function."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    c("Fixed", "Accuracy", "Sensitivity", "Predictions", "ROC", "Confusion Matrix",
      ...
      "Positive Class", "Family", "HParams", "Model", "Dependent"),
    fixed = TRUE)
  # Testing column classes
  expect_equal(
  ...
  expect_equal(
    ...
    c("character", "double", "double", "list", "logical", "list", "list",
      "integer", "integer", "list", "character", "character", "list",
      "list", "character"),
    fixed = TRUE)
  # Testing dimensions
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'hyperparameters': Must have length >= 1, but has length 0."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'hyperparameters': Must be of type 'list' (or 'NULL'), not 'logical'."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'hyperparameters': Must be of type 'list' (or 'NULL'), not 'double'."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    c("Fixed", "Accuracy", "Sensitivity", "Predictions", "ROC", "Confusion Matrix",
      "Coefficients", "Preprocess", "Convergence Warnings", "Other Warnings",
      "Warnings and Messages", "Positive Class", "Family", "Model",
      "Dependent"),
    fixed = TRUE)
  # Testing column classes
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'positive': Must be element of set {'1','2'}, but is '0'."),
    fixed = TRUE)
  expect_equal(
  ...
  expect_equal(
    ...
    xpectr::strip("1 assertions failed:\n * Variable 'positive': Must be of type 'string', not 'NULL'."),
    fixed = TRUE)
  expect_equal(
...
# TODO Add tests of gaussian and multinomial validate_fn !!!
