...
Perform hyperparameter tuning with grid search. Evaluate predictions from an external model. Currently supports regression (`'gaussian'`), binary classification (`'binomial'`), and (some functions only) multiclass classification (`'multinomial'`).
