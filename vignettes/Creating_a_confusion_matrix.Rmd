...
output: 
  ...
  rmarkdown::pdf_document:
    ...
    toc_depth: 4
vignette: >
  %\VignetteIndexEntry{Confusion_Matrix_Intro}
...
If we have two classes (0, 1), we will have these 4 possible combinations of predictions and targets:
