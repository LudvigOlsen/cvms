...
test_that("check_model_specifics()", {

  # xpectr::gxs_function(fn = check_model_specifics,
  #                      args_values = list(
  #                        passed_model_specifics = list(
  #                          list("a" = 1, "b" = NULL, "c" = 3),
  #                          list("a" = 1, "b" = NULL, 3)),
  #                        required_named_arguments = list(
  #                          c("a", "c"), NA, character(0))
  #                      ))


  ## Testing 'check_model_specifics'                                          ####
  ## Initially generated by xpectr
  # Testing different combinations of argument values

  # Testing check_model_specifics(passed_model_specifics =...
  # Testing side effects
  expect_error(
    xpectr::strip_msg(check_model_specifics(passed_model_specifics = list(a = 1, b = NULL, 3), required_named_arguments = c("a", "c"))),
    xpectr::strip(paste0("1 assertions failed:\n * Variable 'passed_model_specifics': ",
           "Must have names, but element 3 is empty.")),
    fixed = TRUE)

  # Testing check_model_specifics(passed_model_specifics =...
  # Testing side effects
  expect_error(
    xpectr::strip_msg(check_model_specifics(passed_model_specifics = list(a = 1, b = NULL, c = 3), required_named_arguments = NA)),
  ...
  # Testing is NULL
  expect_true(
    is.null(check_model_specifics(passed_model_specifics = list(a = 1, b = NULL, c = 3), required_named_arguments = character(0))))

  # Testing check_model_specifics(passed_model_specifics =...
  # Testing is NULL
  expect_true(
    is.null(check_model_specifics(passed_model_specifics = list(a = 1, b = NULL, c = 3), required_named_arguments = c("a", "c"))))

  # Testing check_model_specifics(passed_model_specifics =...
  # Testing side effects
  expect_error(
    xpectr::strip_msg(check_model_specifics(passed_model_specifics = NULL, required_named_arguments = c("a", "c"))),
    xpectr::strip(paste0("1 assertions failed:\n * Variable 'passed_model_specifics': ",
  ...
  # Testing side effects
  expect_error(
    xpectr::strip_msg(check_model_specifics(passed_model_specifics = list(a = 1, b = NULL, c = 3), required_named_arguments = NULL)),
    xpectr::strip(paste0("1 assertions failed:\n * Variable 'required_named_arguments'",
           ": Must be of type 'character', not 'NULL'.")),
    fixed = TRUE)

  ## Finished testing 'check_model_specifics'                                 ####
