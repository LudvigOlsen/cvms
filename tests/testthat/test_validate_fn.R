...
test_that("binomial glm model works with validate_fn()",{
  ...
  #                                type = 'binomial'),
  #              paste0("validate_fn: predictions were NULL."),
  #              fixed = TRUE)
  # expect_error(validate_fn(dat,
  #                                model_fn = glm_model_fn,
  #                                formulas = c("diagnosis~score","diagnosis~age"),
...
#
#   CVbinomlist_prep_all <- validate_fn(
#     data = dat,
#     model_fn = glm_model_fn,
#     predict_fn = glm_predict_fn,
#     preprocess_fn = glm_preprocess_fn,
...
#     positive = 2)
#
#   CVbinomlist_prep_once <- validate_fn(
#     data = dat,
#     model_fn = glm_model_fn,
#     predict_fn = glm_predict_fn,
#     preprocess_fn = glm_preprocess_fn,
...
# })
#
# test_that("gaussian svm models from e1071 work with validate_fn",{
#
...
# })
#
# test_that("gaussian svm models with hparams and preprocessing work with validate_fn",{
#
#   # skip_test_if_old_R_version()
#
#   # Load data and fold it
...
# })
#
# test_that("binomial nnet models work with validate_fn",{
#
...
# })
#
# test_that("gaussian nnet models work with validate_fn",{
#
#   # skip_test_if_old_R_version()
#
#   # Load data and fold it
...
#
#
#   CVmultinomlist <- validate_fn(dat,
...
# })
#
# test_that("gaussian randomForest models work with validate_fn",{
#
#   # skip_test_if_old_R_version()
#
#   # Load data and fold it
...
# })
#
# test_that("binomial keras models work with validate_fn",{
#
...
# })
#
# test_that("binomial tidymodels work with validate_fn",{
#
...
# })
#
# test_that("gaussian lm model with metrics list works with validate_fn",{
#
#   # skip_test_if_old_R_version()
#
#   # Load data and fold it
...
#
# test_that("binomial random predictions work with validate_fn",{
#
...
# })
#
# test_that("gaussian random predictions work with validate_fn",{
#
#   # skip_test_if_old_R_version()
#
#   # Load data and fold it
...
# })
#
# test_that("gaussian results are returned in correct order from validate_fn",{
#
#   # skip_test_if_old_R_version()
#
#   # Load data and fold it
...
# })
#
# test_that("binomial results are returned in correct order from validate_fn",{
#
#   # skip_test_if_old_R_version()
#
#   # Load data and fold it
...
#
#   # Cross-validate the data
#   suppressWarnings(CVed <- validate_fn(dat,
