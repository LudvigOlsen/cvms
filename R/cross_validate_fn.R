...
#'  \strong{RRSE}, \strong{RAE}, \strong{RMSLE} of all the iterations*,
...
#'  along with a count of the class in the target column (\strong{\code{Support}}). These metrics are used to calculate the macro metrics
