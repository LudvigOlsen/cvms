...
[![Travis build status](https://travis-ci.com/LudvigOlsen/cvms.svg?branch=master)](https://travis-ci.com/LudvigOlsen/cvms)
...
* Version `1.0.0` contained **multiple breaking changes**. Please see `NEWS.md`. (13th of April 2020)
